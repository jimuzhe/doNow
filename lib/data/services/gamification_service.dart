...
class GamificationService extends StateNotifier<GamificationState> {
  ...
  static final List<Achievement> _defaultAchievements = [
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANNaUibMhyVDphzzTv-c55n9ZOFfhcAAjoLaxsVpUlWpZeRT_t92ikBAAMCAAN3AAM2BA.png',
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANOaUibRJQbt7ijwx4jgT3Ev6nolycAAjsLaxsVpUlWN2rQOf4Vv_oBAAMCAAN3AAM2BA.png',
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANPaUibZ-3cPBF6AQWc6UKzgPLwEZsAAjwLaxsVpUlWWMG5v1iKV74BAAMCAAN3AAM2BA.png',
      type: AchievementType.totalTasksCompleted,
      targetValue: 25,
    ),
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANRaUibi1w5UZQqUFAhtTV3uCtlDjYAAj8LaxsVpUlWZ1Bw-iPoYZABAAMCAAN3AAM2BA.png',
      type: AchievementType.totalTasksCompleted,
      targetValue: 50,
    ),
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANSaUibmk3gVpMmyd3TJE71hj0cIc0AAkALaxsVpUlWPN54gUjwyZoBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalTasksCompleted,
      targetValue: 100,
    ),
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANQaUibeR_iCdrFdneLfho_N6cU53kAAj0LaxsVpUlWjsQ7sKpNRJgBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalTasksCompleted,
      targetValue: 500,
    ),
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANTaUibsPNVm5spC8pYGRoerVEu-KYAAkELaxsVpUlWrYAzzZcQKWIBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalTasksCompleted,
      targetValue: 1000,
    ),
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANUaUibxJZY93QYLpLbGSkd0z6GyqYAAkILaxsVpUlWlzu9gtBB0h0BAAMCAAN3AAM2BA.png',
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANVaUib-QjVPxj4Oq6GUHnF5OFI7L0AAkMLaxsVpUlWJKAE0UHpAAHvAQADAgADdwADNgQ.png',
      type: AchievementType.totalFocusMinutes,
      targetValue: 120, // 2h
    ),
     const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANWaUicJVOGd8PXvC0kuZBfC9KrK2YAAkQLaxsVpUlW4wcqaeoqquMBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalFocusMinutes,
      targetValue: 600, // 10h
    ),
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANXaUicNHVh-CjfXRGumUIxM78_WF4AAkULaxsVpUlWyoCsC_uBUKQBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalFocusMinutes,
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANYaUicQmqjBlD3Ij2m5-epqiH_9xEAAkYLaxsVpUlW1nh0JVzEK38BAAMCAAN3AAM2BA.png',
      type: AchievementType.totalFocusMinutes,
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANZaUicgOQK9ZdYnWwHtPCRsmb5TtwAAkkLaxsVpUlWrbmf8urqKyMBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalFocusMinutes,
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANMaUibG2Fpepf1Dr-rTetvM35fRGwAAjgLaxsVpUlWC0ZwbO4E5usBAAMCAAN3AAM2BA.png',
      type: AchievementType.totalFocusMinutes,
    ...
    const Achievement(
      ...
      description: '一日之计在于晨。\n在早上 8 点前完成一个任务。',
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANJaUia2sMCkhtlAAEzfMkzyjZAC6StAAI1C2sbFaVJVnXEAf3PHKmWAQADAgADdwADNgQ.png',
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANKaUia63gmxRxNj-rbUKF3vCWk6CYAAjYLaxsVpUlW2Ro6l1tBdKQBAAMCAAN3AAM2BA.png',
    ...
    const Achievement(
      ...
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANIaUiZKGZyyTTrBbie_mTznqmR2FIAAisLaxsVpUlWCK9uqwAB8RiTAQADAgADdwADNgQ.png',
    ...
    const Achievement(
      ...
      title: '周末战士 (Warrior)',
      description: '周末也不放松。\n在周六或周日完成一个任务。',
      icon: 'https://image.name666.top/file/AgACAgUAAyEGAASfXnYUAANLaUibBscjiiK0VD6iodDCK9KTDQoAAjcLaxsVpUlWytus5ytLp6YBAAMCAAN3AAM2BA.png',
