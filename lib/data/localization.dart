...
class AppStrings {
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'task_input_hint': '... (Hold mic to speak)',
      'how_long': 'How long?',
      ...
      'no_tasks_today_hint': 'No tasks for today. Tap the button below to start planning.',
      ...
      'thinking': 'Thinking',
      'rerecord': 'Re-record',
      'i_know_what_to_do': 'I know what to do',
      'listening': 'Listening...',
      'tap_mic_to_start_chat': 'Tap mic to start chat',
      'connecting': 'Connecting...',
      'release_to_cancel': 'Release to cancel',
      'swipe_up_to_cancel': 'Swipe up to cancel',
      'release_to_input': 'Release to type',
      'swipe_down_to_type': 'Swipe down to type',
      'input_text_to_send': 'Type to send',
      'input_text_hint': 'Type something...',
      'input_text_send': 'Send',
      'identifying': 'Listening...',
      'connection_failed': 'Connection failed, retry',
      'no_voice_detected': 'No voice detected, retry',
      'analyzing_insight': 'Finding insight...',
    ...
    'zh': {
      ...
      'steps': '步',
      'no_tasks_yet': '暂无任务',
      'no_tasks_today_hint': '今天还没有任务，点击下方按钮开始规划吧',
      ...
      'thinking': '正在思考',
      'rerecord': '重新录入',
      'i_know_what_to_do': '我知道怎么做了',
      'listening': '正在聆听...',
      'tap_mic_to_start_chat': '点击麦克风开始对话',
      'connecting': '正在连接...',
      'release_to_cancel': '松开取消',
      'swipe_up_to_cancel': '上滑取消',
      'release_to_input': '松开输入',
      'swipe_down_to_type': '下滑打字',
      'input_text_to_send': '输入文字发送',
      'input_text_hint': '输入文字...',
      'input_text_send': '发送',
      'identifying': '正在识别...',
      'connection_failed': '连接失败，请重试',
      'no_voice_detected': '未能识别到语音，请重试',
      'analyzing_insight': '正在感悟...',
